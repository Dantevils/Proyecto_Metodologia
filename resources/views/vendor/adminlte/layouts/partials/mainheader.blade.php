...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
        ...
        <span class="logo-mini"><b>Y</b>ZF</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>YZF</b>Company</span>
    </a>
                            ...
                            <ul class="menu">
                                <li><!-- start message -->
                                    <a href="#">
                                        <div class="pull-left">
                                            <!-- User Image -->
                                            <img src="/img/avatar.png" class="img-circle" alt="User Image"/>  {{-- Gravatar::get($user->email)--}}
                                        </div>
